      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 w-full max-w-2xl">
        {filtered.map((school) => (
          <div key={school.id} className="relative">
            ...
            {!school.live && (
              <span className="absolute top-3 right-3 bg-transparent text-red-400 text-[10px] font-semibold px-2 py-0.5 rounded-full tracking-wide uppercase pointer-events-none">
                Coming Soon
              </span>
            )}
          </div>
